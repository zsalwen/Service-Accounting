...
<tr <? if ($d[code410]){ echo "style='background-color:ccffcc;'";}?>>
	...
	<td style="border-right:solid #999999 5px;"><a href="http://staff.mdwestserve.com/invoice.html.php?packet=EV<?=$d[eviction_id];?>" target="_Blank"><b>Unpaid: $<?=$due?></b></a></td>
</tr>
<? }  } ?>
</table>
<?
