...
dbConnect();
if ($_GET[id] == "last"){
	$q77 = "SELECT * FROM schedule_items ORDER BY schedule_id DESC";
...
function accord(id){
	...
	if (id=='acc'){
		show(document.getElementById('acc'))
		hide(document.getElementById('pub'))
		hide(document.getElementById('prop'))
		hide(document.getElementById('sale'))
		hide(document.getElementById('history'))
		hide(document.getElementById('system'))
	...
	if (id=='prop'){
		show(document.getElementById('prop'))
		hide(document.getElementById('acc'))
		hide(document.getElementById('pub'))
		hide(document.getElementById('sale'))
		hide(document.getElementById('history'))
	...
	if (id=='sale'){
		show(document.getElementById('sale'))
		hide(document.getElementById('prop'))
		hide(document.getElementById('acc'))
		hide(document.getElementById('pub'))
		hide(document.getElementById('history'))
	...
	if (id=='history'){
		show(document.getElementById('history'))
		hide(document.getElementById('sale'))
		hide(document.getElementById('prop'))
		hide(document.getElementById('acc'))
		hide(document.getElementById('pub'))
	...
	if (id=='system'){
		show(document.getElementById('system'))
		hide(document.getElementById('history'))
		hide(document.getElementById('sale'))
		hide(document.getElementById('prop'))
		hide(document.getElementById('acc'))
	...
	if (id=='att'){
		show(document.getElementById('att'))
		hide(document.getElementById('system'))
		hide(document.getElementById('history'))
		hide(document.getElementById('sale'))
		hide(document.getElementById('prop'))
...
?>
<table width="1095px" border="1" height="400px" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
    ...
    <?
        ...
        <strong>
        	...
        	Auction #<?=$data3[schedule_id]?> ::		
			<?=$data3[address1];?>, <?=$data3[state];?>::
            <? if ($data3['private']){ echo "Not on Website ::";}?>
	        <?=$sale;?> <?=$data3[sale_time];?> ::
            <?=$data3[item_status]?> :: 
...
<!-- we moved this here since it the most clicked item -->
...
Access Log<br />
        <? 
        $qn="SELECT *, DATE_FORMAT(stamp_date,'%b %e %h:%i%p') as stamp_date_f FROM auction_views WHERE auction_id = '$data3[schedule_id]'";
		$rn=@mysql_query($qn);
		...
		<? } ?>
                    ...
                    <td class="left" valign="top">
            <ol>
                <li <?=$mouseover?>><a onmouseover="accord('status')" style="text-decoration:none">Auction Status</a></li>
                <li <?=$mouseover?>><a onmouseover="accord('pub')" style="text-decoration:none">Publication Info</a></li>
                <li <?=$mouseover?>><a onmouseover="accord('acc')" style="text-decoration:none">Accounting Information</a></li>
                <li <?=$mouseover?>><a onmouseover="accord('prop')" style="text-decoration:none">Properties Information</a></li>
                <li <?=$mouseover?>><a onmouseover="accord('sale')" style="text-decoration:none">Sale Information</a></li>
                <li <?=$mouseover?>><a onmouseover="accord('system')" style="text-decoration:none">System Information</a></li>
                <li <?=$mouseover?>><a onmouseover="accord('att')" style="text-decoration:none">Attorney Information</a></li>
            </ol>
					</td>
                </tr>
           </table>
...
<table id="portal" style="display: block;" width="100%" bgcolor="#FFFFFF">
	<tr>
...
<table id="pub" style="display: none;" bgcolor="#FFFFFF">
...
<table id="acc" style="display: none;" bgcolor="#FFFFFF">
	<tr>
...
<table id="prop" style="display: none;" bgcolor="#FFFFFF">
	<tr>
...
<table id="sale" style="display: none;" bgcolor="#FFFFFF">
	<tr>
...
<table id="system" style="display: none;" bgcolor="#FFFFFF">
	<tr>
...
<table id="status" style="display: block;" bgcolor="#FFFFFF">
	<tr>
		<td class="left">
...
<table id="att" style="display: block;" bgcolor="#FFFFFF">
