...
$q="SELECT * FROM ps_packets where server_ida = '$id' AND process_status = 'ASSIGNED'";
//$q="SELECT * FROM ps_packets where server_id = '$id' AND process_status = 'INVOICED'";
$r=@mysql_query($q);
...
$details = "<table width='100%' cellspacing='0'><tr><td>ID</td><td>Recieved</td><td>Service</td><td>Printing</td><td style='padding-left:20px'>Balance</td></tr>";
$svc=0;
$ptr=0;
while ($d=mysql_fetch_array($r, MYSQL_ASSOC)){
